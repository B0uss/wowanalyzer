...
export const THISTLE_TEA_CAST_BUFFER_MS = 50;

const FROM_HARDCAST = 'FromHardcast';
const RESOURCE_CHANGE = 'ResourceChange';

export const THISTLE_TEA_EVENT_LINKS: EventLink[] = [
  {
    ...
    forwardBufferMs: THISTLE_TEA_CAST_BUFFER_MS,
    backwardBufferMs: THISTLE_TEA_CAST_BUFFER_MS,
    anyTarget: true,
  },
];
...
export default class ThistleTeaCastLinkNormalizer extends EventLinkNormalizer {
  constructor(options: Options) {
    super(options, THISTLE_TEA_EVENT_LINKS);
  }
}
